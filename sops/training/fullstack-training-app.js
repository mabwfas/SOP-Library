...
// Full-Stack Developer Training Application Logic

// State Management
let currentTask = 0;
let currentQuestion = 0;
let userAnswers = [];
let progress = JSON.parse(localStorage.getItem('fullstackTrainingProgress')) || { completedTasks: [], currentTask: 1 };
let traineeName = localStorage.getItem('dhTraineeName') || localStorage.getItem('fullstackTraineeName') || '';
...
function resetProgress() {
    localStorage.removeItem('fullstackTrainingProgress');
    location.reload();
}
...
function showCertificate() {
    ...
    modal.innerHTML = `
        <div id="certificateContent" style="
            ...
            padding: 60px;
            position: relative;
            box-shadow: 0 0 60px rgba(139, 92, 246, 0.3), inset 0 0 60px rgba(139, 92, 246, 0.05);
        ">
            <!-- Close Button -->
            ...
            <div style="text-align: center; margin-bottom: 40px;">
                ...
                <h3 style="
                    ...
                    color: #8B5CF6;
                    margin-bottom: 25px;
                ">Full-Stack Developer Training</h3>
                
                <p style="color: #CBD5E1; font-size: 1em; line-height: 1.6; max-width: 600px; margin: 0 auto;">
                    Demonstrating proficiency in full-stack development, frontend & backend integration, Shopify APIs, database management, security practices, testing, and deployment pipelines.
                </p>
            </div>
            ...
            <div style="text-align: center; margin-top: 30px;">
                ...
                ">
                    ...
                    <span style="color: #8B5CF6; font-weight: 700; font-family: monospace; letter-spacing: 0.1em;">
                        DH-FS-${Date.now().toString(36).toUpperCase()}-${Math.random().toString(36).substring(2, 6).toUpperCase()}
                    </span>
                </div>
            </div>
    ...
    modal.innerHTML = `
        ...
        ">
            ...
            <h1 style="
                ...
                color: #F8FAFC;
                margin-bottom: 10px;
            ">Welcome to Full-Stack Developer Training</h1>
...
function saveTraineeName() {
    ...
    traineeName = name;
    localStorage.setItem('fullstackTraineeName', name);
