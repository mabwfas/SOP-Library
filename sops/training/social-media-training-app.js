// Social Media Training Application Logic

// State Management
let currentTask = 0;
let currentQuestion = 0;
let userAnswers = [];
let progress = JSON.parse(localStorage.getItem('social-mediaTrainingProgress')) || { completedTasks: [], currentTask: 1 };
let traineeName = localStorage.getItem('dhTraineeName') || localStorage.getItem('social-mediaTraineeName') || '';
...
function showResults() {
    ...
    if (passed) {
        ...
        localStorage.setItem('social-mediaTrainingProgress', JSON.stringify(progress));
...
function resetProgress() {
    localStorage.removeItem('social-mediaTrainingProgress');
    location.reload();
}
...
function showCertificate() {
    ...
    modal.innerHTML = `
        <div id="certificateContent" style="
            ...
            padding: 60px;
            position: relative;
            box-shadow: 0 0 60px rgba(239, 68, 68, 0.3), inset 0 0 60px rgba(239, 68, 68, 0.05);
        ">
            <!-- Close Button -->
            ...
            <div style="text-align: center; margin-bottom: 40px;">
                ...
                <h3 style="
                    ...
                    color: #EF4444;
                    margin-bottom: 25px;
                ">Social Media Manager Training</h3>
                
                <p style="color: #CBD5E1; font-size: 1em; line-height: 1.6; max-width: 600px; margin: 0 auto;">
                    Demonstrating proficiency in social media strategy, content calendars, platform best practices, community management, analytics, paid advertising, and engagement tactics.
                </p>
            </div>
            ...
            <div style="text-align: center; margin-top: 30px;">
                ...
                ">
                    ...
                    <span style="color: #EF4444; font-weight: 700; font-family: monospace; letter-spacing: 0.1em;">
                        DH-SMM-${Date.now().toString(36).toUpperCase()}-${Math.random().toString(36).substring(2, 6).toUpperCase()}
                    </span>
                </div>
            </div>
            ...
            <div style="text-align: center; margin-top: 40px;" class="no-print">
                ...
                " onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 10px 30px rgba(239, 68, 68, 0.4)';"
    ...
    modal.innerHTML = `
        ...
        ">
            ...
            <h1 style="
                ...
                color: #F8FAFC;
                margin-bottom: 10px;
            ">Welcome to Social Media Manager Training</h1>
            ...
            <div style="text-align: left; margin-bottom: 25px;">
                ...
                <input type="text" id="traineeNameInput" placeholder="e.g. John Smith" style="
                    ...
                    font-size: 1.1em;
                    outline: none;
                " onfocus="this.style.borderColor='#EF4444'" onblur="this.style.borderColor='rgba(239, 68, 68, 0.3)'">
            </div>
...
function saveTraineeName() {
    ...
    traineeName = name;
    localStorage.setItem('social-mediaTraineeName', name);
