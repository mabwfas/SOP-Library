...
<p>Per-order commission when monthly sales exceed $20,000: 1% (under $2k), 2% ($2k–$5k), 3% ($5k+). Subject to Delhi team's decision. Credited 1 month after order delivery.</p>
</div>
...
const task20Quiz = [
    ...
    { q: "A sales rep closed $22,000 in monthly sales including a $3,000 order. Their commission on that order per DH policy is:", o: ["₹0 — sales incentives only apply after 12 months of employment as per the standard vesting schedule", "1% of $3,000 — orders under $2k get 1% so this falls in the next tier but gets the lower rate", "2% of $3,000 ($60) — the $2k–$5k order tier earns 2% per-order commission", "3% of $3,000 — all orders above $2k earn the highest commission rate regardless of order value"], c: 2 },
