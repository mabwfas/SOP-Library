...
let userAnswers = [];
let progress = JSON.parse(localStorage.getItem('financeTrainingProgress')) || { completedTasks: [], currentTask: 1 };
let traineeName = localStorage.getItem('dhTraineeName') || localStorage.getItem('financeTraineeName') || '';
...
function resetProgress() {
    localStorage.removeItem('financeTrainingProgress');
    location.reload();
}
...
function showCertificate() {
    ...
    modal.innerHTML = `
        <div id="certificateContent" style="
            ...
            padding: 60px;
            position: relative;
            box-shadow: 0 0 60px rgba(234, 179, 8, 0.3), inset 0 0 60px rgba(234, 179, 8, 0.05);
        ">
            <!-- Close Button -->
            ...
            <div style="text-align: center; margin-top: 30px;">
                ...
                ">
                    ...
                    <span style="color: #EAB308; font-weight: 700; font-family: monospace; letter-spacing: 0.1em;">
                        DH-FIN-${Date.now().toString(36).toUpperCase()}-${Math.random().toString(36).substring(2, 6).toUpperCase()}
                    </span>
                </div>
            </div>
            ...
            <div style="text-align: center; margin-top: 40px;" class="no-print">
                ...
                " onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 10px 30px rgba(234, 179, 8, 0.4)';"
    ...
    modal.innerHTML = `
        ...
        ">
            ...
            <h1 style="
                ...
                color: #F8FAFC;
                margin-bottom: 10px;
            ">Welcome to Finance Executive Training</h1>
            ...
            <div style="text-align: left; margin-bottom: 25px;">
                ...
                <input type="text" id="traineeNameInput" placeholder="e.g. John Smith" style="
                    ...
                    font-size: 1.1em;
                    outline: none;
                " onfocus="this.style.borderColor='#EAB308'" onblur="this.style.borderColor='rgba(234, 179, 8, 0.3)'">
            </div>
...
function saveTraineeName() {
    ...
    traineeName = name;
    localStorage.setItem('financeTraineeName', name);
