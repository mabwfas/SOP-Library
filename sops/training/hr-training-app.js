...
function showResults() {
    ...
    if (passed) {
        ...
        localStorage.setItem('hrTrainingProgress', JSON.stringify(progress));
...
function resetProgress() {
    localStorage.removeItem('hrTrainingProgress');
    location.reload();
}
...
function showCertificate() {
    ...
    modal.innerHTML = `
        <div id="certificateContent" style="
            ...
            padding: 60px;
            position: relative;
            box-shadow: 0 0 60px rgba(34, 197, 94, 0.3), inset 0 0 60px rgba(34, 197, 94, 0.05);
        ">
            <!-- Close Button -->
            ...
            <div style="text-align: center; margin-bottom: 40px;">
                ...
                <h3 style="
                    ...
                    color: #22C55E;
                    margin-bottom: 25px;
                ">HR Executive Training</h3>
                
                <p style="color: #CBD5E1; font-size: 1em; line-height: 1.6; max-width: 600px; margin: 0 auto;">
                    Demonstrating proficiency in HR processes, recruitment, onboarding, employee relations, performance management, policy compliance, documentation, and team building.
                </p>
            </div>
            ...
            <div style="text-align: center; margin-top: 30px;">
                ...
                ">
                    ...
                    <span style="color: #22C55E; font-weight: 700; font-family: monospace; letter-spacing: 0.1em;">
                        DH-HR-${Date.now().toString(36).toUpperCase()}-${Math.random().toString(36).substring(2, 6).toUpperCase()}
                    </span>
                </div>
            </div>
            ...
            <div style="text-align: center; margin-top: 40px;" class="no-print">
                ...
                " onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 10px 30px rgba(34, 197, 94, 0.4)';"
    ...
    modal.innerHTML = `
        ...
        ">
            ...
            <h1 style="
                ...
                color: #F8FAFC;
                margin-bottom: 10px;
            ">Welcome to HR Manager Training</h1>
            ...
            <div style="text-align: left; margin-bottom: 25px;">
                ...
                <input type="text" id="traineeNameInput" placeholder="e.g. John Smith" style="
                    ...
                    font-size: 1.1em;
                    outline: none;
                " onfocus="this.style.borderColor='#22C55E'" onblur="this.style.borderColor='rgba(34, 197, 94, 0.3)'">
            </div>
