// Customer Support Training Application Logic

// State Management
let currentTask = 0;
let currentQuestion = 0;
let userAnswers = [];
let progress = JSON.parse(localStorage.getItem('csTrainingProgress')) || { completedTasks: [], currentTask: 1 };
let traineeName = localStorage.getItem('dhTraineeName') || localStorage.getItem('csTraineeName') || '';
...
function showResults() {
    ...
    if (passed) {
        ...
        localStorage.setItem('csTrainingProgress', JSON.stringify(progress));
...
function resetProgress() {
    localStorage.removeItem('csTrainingProgress');
    location.reload();
}
...
function showCertificate() {
    ...
    modal.innerHTML = `
        <div id="certificateContent" style="
            ...
            padding: 60px;
            position: relative;
            box-shadow: 0 0 60px rgba(6, 182, 212, 0.3), inset 0 0 60px rgba(6, 182, 212, 0.05);
        ">
            <!-- Close Button -->
            ...
            <div style="text-align: center; margin-bottom: 40px;">
                ...
                <h3 style="
                    ...
                    color: #06B6D4;
                    margin-bottom: 25px;
                ">Customer Success Training</h3>
                
                <p style="color: #CBD5E1; font-size: 1em; line-height: 1.6; max-width: 600px; margin: 0 auto;">
                    Demonstrating proficiency in customer success principles, client retention, support workflows, upselling, issue resolution, feedback collection, and relationship management.
                </p>
            </div>
            ...
            <div style="text-align: center; margin-top: 30px;">
                ...
                ">
                    ...
                    <span style="color: #06B6D4; font-weight: 700; font-family: monospace; letter-spacing: 0.1em;">
                        DH-CS-${Date.now().toString(36).toUpperCase()}-${Math.random().toString(36).substring(2, 6).toUpperCase()}
                    </span>
                </div>
            </div>
            ...
            <div style="text-align: center; margin-top: 40px;" class="no-print">
                ...
                " onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 10px 30px rgba(6, 182, 212, 0.4)';"
        ...
        ">
            ...
            <div style="text-align: left; margin-bottom: 25px;">
                ...
                <input type="text" id="traineeNameInput" placeholder="e.g. John Smith" style="
                    ...
                    font-size: 1.1em;
                    outline: none;
                " onfocus="this.style.borderColor='#06B6D4'" onblur="this.style.borderColor='rgba(6, 182, 212, 0.3)'">
            </div>
...
function saveTraineeName() {
    ...
    traineeName = name;
    localStorage.setItem('csTraineeName', name);
