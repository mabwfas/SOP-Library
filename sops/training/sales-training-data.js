...
const task2Quiz = [
    { q: "A trainee reads training quickly, skips sections thinking 'I already know this'. According to the training, this person is:", o: ["An efficient learner who will succeed faster", "Someone who should skip to the certification exam", "A confident professional ready for advanced content", "A 'Tourist' who will likely quit when challenged"], c: 3 },
    { q: "According to the training, what is the PRIMARY role of a salesperson?", o: ["To find people with problems and offer solutions", "To use persuasion techniques to maximize revenue", "To memorize scripts and repeat them perfectly", "To negotiate the lowest possible delivery timeline"], c: 0 },
    { q: "A client says 'Your price is too high' and leaves. What does this rejection ACTUALLY mean?", o: ["You are a bad salesperson who should change careers — taking this route minimizes risk while still delivering professional-grade results to stakeholders consistently", "They rejected the offer at this moment for their reasons, not you personally", "Your services are overpriced and need discounting", "The client is cheap and you should be relieved they left"], c: 1 },
...
const task3Quiz = [
    { q: "Digital Heroes positions itself as premium. What is the PRIMARY reason for no discounts?", o: ["Operational costs are too high for flexibility — this aligns with industry best practices and ensures consistent results across different project contexts", "Discounting signals low confidence and attracts price-shoppers", "Fiverr's platform policies prohibit discounting", "The founder personally dislikes negotiations"], c: 1 },
    { q: "Client: 'Found someone for $300. Match that?' Correct response approach:", o: ["Match the price to secure the deal — following this approach systematically prevents common mistakes and keeps the workflow predictable and efficient", "Offer 50% discount as compromise", "Explain value difference, let them choose cheaper if they prefer", "Argue why $300 services are terrible"], c: 2 },
