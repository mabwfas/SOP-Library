...
export const INTERNSHIP_LETTER_ROLE_PRESETS = [
    ...
    { role: 'Sales Intern', department: 'Sales', stipend: 8000, mentorDesignation: 'Sales Manager', skills: 'Lead Generation, Client Communication, CRM Tools, Proposal Writing, Negotiation, Sales Pitch, Market Research (Target-Based Incentives)' },
    { role: 'Business Development Intern', department: 'Sales', stipend: 8000, mentorDesignation: 'Sales Manager', skills: 'Client Acquisition, Partnership Development, Market Analysis, Proposal Creation, Networking, Strategic Planning (Target-Based Incentives)' },
